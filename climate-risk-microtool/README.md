...
![CI](https://github.com/ORG/climate-risk-microtool/actions/workflows/ci.yml/badge.svg)
![Pipeline](https://github.com/ORG/climate-risk-microtool/actions/workflows/pipeline.yml/badge.svg)
![Pages](https://img.shields.io/badge/pages-enabled-brightgreen)

Estimate local climate risk indicators from compact public proxies and scenario assumptions.
