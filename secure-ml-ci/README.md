...
![CI](https://github.com/ORG/secure-ml-ci/actions/workflows/ci.yml/badge.svg)
![Pipeline](https://github.com/ORG/secure-ml-ci/actions/workflows/pipeline.yml/badge.svg)
![Pages](https://img.shields.io/badge/pages-enabled-brightgreen)

Add security checks to ML pipelines including dependency and model artifact integrity validation.
