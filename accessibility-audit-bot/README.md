...
![CI](https://github.com/ORG/accessibility-audit-bot/actions/workflows/ci.yml/badge.svg)
![Pipeline](https://github.com/ORG/accessibility-audit-bot/actions/workflows/pipeline.yml/badge.svg)
![Pages](https://img.shields.io/badge/pages-enabled-brightgreen)

Run fast accessibility heuristics on small HTML snapshots and prioritize remediation tasks.
