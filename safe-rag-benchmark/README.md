...
![CI](https://github.com/ORG/safe-rag-benchmark/actions/workflows/ci.yml/badge.svg)
![Pipeline](https://github.com/ORG/safe-rag-benchmark/actions/workflows/pipeline.yml/badge.svg)
![Pages](https://img.shields.io/badge/pages-enabled-brightgreen)

Benchmark small retrieval-augmented generation pipelines with safety-focused scoring and citation traceability.
