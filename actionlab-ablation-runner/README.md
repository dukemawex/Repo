...
![CI](https://github.com/ORG/actionlab-ablation-runner/actions/workflows/ci.yml/badge.svg)
![Pipeline](https://github.com/ORG/actionlab-ablation-runner/actions/workflows/pipeline.yml/badge.svg)
![Pages](https://img.shields.io/badge/pages-enabled-brightgreen)

Rapidly compare lightweight model variants and feature subsets with reproducible ablation studies for small tabular tasks.
