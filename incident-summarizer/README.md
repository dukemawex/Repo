...
![CI](https://github.com/ORG/incident-summarizer/actions/workflows/ci.yml/badge.svg)
![Pipeline](https://github.com/ORG/incident-summarizer/actions/workflows/pipeline.yml/badge.svg)
![Pages](https://img.shields.io/badge/pages-enabled-brightgreen)

Summarize incident timelines from log snippets and ticket notes for faster incident response handoffs.
